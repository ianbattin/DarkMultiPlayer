...
namespace DarkMultiPlayer
{
    public class CraftLibraryWorker
    {
        ...
        public void Draw()
        {
            ...
            if (safeDisplay)
            {
                playerWindowRect = DMPGuiUtil.PreventOffscreenWindow(GUILayout.Window((int)WindowId.CRAFT_PLAYER_WINDOW + Client.WINDOW_OFFSET, playerWindowRect, DrawPlayerContent, "DarkMultiPlayer - Craft Library", windowStyle, playerLayoutOptions));
            }
            if (safeDisplay && selectedPlayer != null)
            {
                ...
                {
                    libraryWindowRect = DMPGuiUtil.PreventOffscreenWindow(GUILayout.Window((int)WindowId.CRAFT_LIBRARY_WINDOW + Client.WINDOW_OFFSET, libraryWindowRect, DrawLibraryContent, "DarkMultiPlayer - " + selectedPlayer + " Craft Library", windowStyle, libraryLayoutOptions));
                }
                else
                {
                    selectedPlayer = null;
